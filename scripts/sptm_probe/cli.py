...
def main():
    ...
    ap.add_argument('--xnu-gl1-fast-redirect', action='store_true', help='After the verified XNU prefix only, accelerate eleven pinned GL1 exception-bank HVC sites through live GL12 aliases; requires --xnu-run')
